...
|youtube|5|<li>全屏广告-视频播放-跳过广告<li>全屏广告-视频播放-赞助商广告<li>局部广告-首页会员广告<li>全屏广告-订阅浮窗广告<li>权限提示-通知权限|
...
|爱奇艺|6|<li>开屏广告<li>青少年模式<li>局部广告-我的页面顶部广告<li>权限提示-通知权限<li>更新提示<li>全屏广告-播放页-插入广告|
|爱奇艺极速版|1|<li>开屏广告|
...
|百度百科|1|<li>权限提示-通知权限|
|百度地图|9|<li>局部广告-地图上方黄页横幅<li>局部广告-打车界面右侧悬浮球<li>全屏广告-美食大礼包弹窗<li>全屏广告-酒店提前订弹窗<li>权限提示-定位权限<li>全屏广告-打车界面弹窗广告<li>更新提示<li>权限提示-通知权限<li>功能类-通勤卡添加至桌面|
|百度输入法|3|<li>开屏广告<li>全屏广告-创作祝福弹窗<li>局部广告-底部会员悬浮卡片|
|百度贴吧|12|<li>开屏广告<li>权限提示-通知权限<li>分段广告-信息流广告<li>局部广告-首页、推荐列表顶部卡片广告<li>更新提示<li>分段广告-帖子底部内容推荐卡片<li>全屏广告-弹窗广告<li>局部广告-悬浮小广告<li>局部广告-帖子内"进吧逛逛"弹窗<li>功能类-贴吧内签到并关闭弹窗<li>局部广告-帖子底部话题卡片<li>全屏广告-会员弹窗|
...
|菜鸟|8|<li>全屏广告-弹窗广告<li>局部广告-包裹页面-地图底部横条广告<li>更新提示<li>权限提示-通知权限<li>评价提示<li>全屏广告-今日手气红包<li>全屏广告-发现页新装试用弹窗<li>功能类-询问[是否要查询包裹]弹窗|
|畅听FM|1|<li>全屏广告-弹窗广告|
|超级课程表|4|<li>局部广告-首页卡片广告<li>局部广告-课程表界面广告<li>全屏广告-弹窗广告<li>更新提示|
|车来了|2|<li>局部广告-卡片广告<li>更新提示|
|车旺大卡|1|<li>全屏广告-弹窗广告|
|车学堂|1|<li>局部广告-卡片广告|
|初音社|1|<li>全屏广告-谷歌广告|
|楚税通|1|<li>更新提示|
...
|大学搜题酱|7|<li>开屏广告<li>全屏广告-弹窗广告<li>局部广告-卡片广告<li>更新提示<li>权限提示-通知权限<li>评价提示-请求好评弹窗<li>全屏广告-邀好友得开学好礼|
...
|懂车帝|8|<li>分段广告-首页推荐卡片广告<li>更新提示<li>局部广告-右下角悬浮窗<li>局部广告-文章底部卡片广告<li>局部广告-评论区信息流广告<li>权限提示-通知权限<li>局部广告-选车页卡片广告<li>局部广告-车型页面右下角直播悬浮窗|
...
|抖音|17|<li>局部广告-关闭用户推荐<li>更新提示-关闭更新弹窗<li>局部广告-首页左上角广告<li>全屏广告-弹窗广告<li>评价提示-去商店评分<li>功能类-设置无声进入抖音弹窗<li>权限提示-通知权限<li>功能类-自动勾选原图<li>全屏广告-休息提醒<li>功能类-[添加快捷方式到桌面]弹窗<li>全屏广告-视频播放中途插入的打招呼界面<li>全屏广告-关闭商城推荐<li>局部广告-拍同款弹窗<li>全屏广告-[去首页商城]弹窗<li>全屏广告-低价秒杀券弹窗<li>权限提示-请求访问通讯录弹窗<li>青少年模式|
|抖音极速版|5|<li>青少年模式<li>功能类-功能体验邀请弹窗<li>全屏广告-朋友推荐弹窗<li>权限提示-通知权限<li>功能类-选择图片时自动勾选原图|
|斗鱼|3|<li>青少年模式<li>更新提示<li>局部广告-直播间广告|
|豆瓣|9|<li>功能类-不分享/同步作品短评<li>分段广告-剧照广告<li>分段广告-信息流广告<li>分段广告-卡片广告<li>评价提示-关闭评分反馈弹窗<li>分段广告-搜索页/帖子内容与评论区中间的卡片广告<li>局部广告-个性化内容推荐弹窗<li>全屏广告-弹窗广告<li>更新提示|
|毒霸姬|1|<li>更新提示|
...
|广东税务|1|<li>权限提示-通知权限|
|果冻宝盒|1|<li>全屏广告-弹窗广告|
|哈啰|8|<li>权限提示-通知权限<li>权限提示-定位权限<li>全屏广告-应用内活动、弹窗广告（大部分）<li>全屏广告-哈啰智能电动车-弹窗广告<li>局部广告-右侧悬浮广告<li>全屏广告-骑行订单完成-弹窗广告<li>全屏广告-骑行卡-优惠券弹窗<li>功能类-新人教学弹窗|
...
|京东|9|<li>局部广告-购物车页面砸金蛋<li>局部广告-悬浮广告<li>权限提示-通知权限<li>全屏广告-弹窗广告<li>局部广告-横幅广告<li>功能类-京东账号登录授权<li>局部广告-支付页面产品推荐<li>全屏广告-购物车页面支付成功弹窗广告<li>全屏广告-加入购物车后出现的弹窗|
...
|酷安|4|<li>开屏广告<li>分段广告-卡片广告<li>更新提示<li>权限提示-通知权限|
...
|美团|9|<li>更新提示<li>全屏广告-弹窗广告<li>评价提示-订单调查弹窗<li>局部广告-首页右侧抽奖小广告<li>权限提示-定位权限<li>权限提示-通知权限<li>全屏广告-新人返场特惠<li>全屏广告-视频页弹窗广告<li>功能类-付款后自动点击完成|
...
|腾讯会议|1|<li>更新提示|
|腾讯视频|8|<li>开屏广告<li>青少年模式<li>更新提示<li>分段广告-卡片广告<li>全屏广告-视频播放时的广告<li>全屏广告-首页-弹窗广告<li>权限提示-通知权限<li>局部广告-卡片广告|
...
|微博|14|<li>全屏广告-兴趣领域推荐<li>全屏广告-精选博主推荐<li>局部广告-博文内容区与评论区中间卡片广告<li>局部广告-评论区博主内容推荐<li>局部广告-首页顶部话题分享窗口<li>全屏广告-弹窗广告<li>权限提示-通知权限<li>局部广告-首页顶部签到卡片<li>局部广告-悬浮广告<li>权限提示-定位权限<li>分段广告-信息流广告<li>评价提示-APP评分弹窗<li>功能类-自动点击查看原图<li>功能类-超话自动签到|
...
|无界趣连|1|<li>更新提示|
|无线魔盒|1|<li>更新提示|
|无忧行|2|<li>全屏广告-弹窗广告<li>权限提示-定位权限|
|五寸方|1|<li>全屏广告-弹窗广告|
|西瓜视频|4|<li>青少年模式<li>更新提示<li>权限提示-通知权限<li>全屏广告-红包弹窗|
|稀饭动漫|1|<li>全屏广告-弹窗广告|
|稀土掘金|1|<li>更新提示|
|喜马拉雅|13|<li>局部广告-首页右侧浮动广告<li>局部广告-播放页面-播放控制区域的广告<li>局部广告-播放页面-底部推荐列表-夹杂广告<li>局部广告-播放页面-播放前广告<li>分段广告-首页-推荐列表广告<li>局部广告-热播推荐广告<li>更新提示<li>青少年模式<li>局部广告-评论区广告<li>分段广告-卡片广告<li>全屏广告-首页-专辑订阅推荐弹窗<li>全屏广告-弹窗广告<li>权限提示-通知权限|
...
|小红帽|1|<li>全屏广告-弹窗广告|
|小红书|5|<li>权限提示-通知权限<li>更新提示<li>分段广告-信息流广告<li>全屏广告-优惠券弹窗<li>评价提示-评分弹窗|
...
|小米手机管家|6|<li>功能类-自动继续安装<li>功能类-禁止获取定位<li>功能类-使用返回退出时直接点击[退出]<li>功能类-电量已低于20%<li>功能类-高敏感权限自动确定<li>功能类-应用信息页-自启动提示|
...
|迅雷|10|<li>开屏广告<li>分段广告-视频详情页广告<li>分段广告-视频详情页直播推荐<li>全屏广告-应用内弹窗广告<li>分段广告-"下载页"卡片广告<li>局部广告-搜索页面顶部广告<li>更新提示<li>全屏广告-会员续费广告<li>局部广告-卡片广告<li>权限提示-通知权限|
|迅游手游加速器|2|<li>开屏广告<li>分段广告-卡片广告|
|烟花动漫|1|<li>全屏广告-弹窗广告|
|央视体育|1|<li>全屏广告-弹窗广告|
|央视新闻|2|<li>局部广告-卡片广告<li>功能类-个性化推荐弹窗|
|一个木函|1|<li>更新提示|
|一刻相册|8|<li>更新提示-软件升级提醒<li>局部广告-悬浮窗广告<li>评价提示<li>全屏广告-会员充值提示<li>全屏广告-弹窗广告<li>权限提示-通知权限<li>局部广告-照片页底部浮窗广告<li>局部广告-卡片广告|
...
|游民星空|2|<li>局部广告-卡片广告<li>功能类-签到成功弹窗|
...
|浙里办|1|<li>更新提示|
|真不卡|2|<li>通知提示-温馨提示弹窗<li>分段广告-看视频领奖励广告|
|正气|2|<li>更新提示<li>全屏广告-弹窗广告|
|支付宝|15|<li>全屏广告-关闭花呗升级弹窗<li>权限提示-定位权限<li>权限提示-通知权限<li>更新提示-版本更新弹窗<li>功能类-设置支付宝小组件<li>全屏广告-借呗消费信贷协议<li>功能类-支付后自动点击完成<li>全屏广告-领新年红包弹窗<li>全屏广告-"下次支付用花呗"弹窗<li>分段广告-扫码乘车后出现的广告<li>功能类-关闭免密支付开关<li>分段广告-服务消息页面-卡片广告<li>功能类-[0元下单权益]弹窗<li>局部广告-卡片广告<li>其他-蚂蚁理财社区-[加入同路人]弹窗|
...
|中国人保|1|<li>更新提示|
|中国移动|6|<li>更新提示<li>全屏广告-首页弹窗广告<li>权限提示-通知权限<li>权限提示-请求获取剪贴板权限弹窗<li>局部广告-右侧悬浮小图标<li>评价提示-请求好评弹窗|
